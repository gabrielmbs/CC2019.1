...
class ContatoTest {
	...
	void ConstrutorTeste() {
		...
		//Testando nome nulo e o nome vazio.
		...
		//Testando o sobrenome nulo e o sobrenome vazio
		...
		//Testando o telefone nulo e o telefone vazio
	...
	void equalsValoresIguaisTeste() {
		...
		assertTrue(this.contato.equals(contato));
	}
	...
	void hashCodeTeste() {
		Contato contato2 = new Contato("Gabriel", "Mareco", "5435-534");
		assertEquals(this.contato.hashCode(), contato2.hashCode());
	}
}